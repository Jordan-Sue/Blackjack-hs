...
checkBust (State (playerHand, computerHand, dealerHand, deck) bet cbet cunit count turn pStand cStand dStand pBust cBust)
    ...
    | getHandValue playerHand > 21 && cBust == 1 = EndOfGame (State (playerHand, computerHand, dealerHand, deck) bet cbet cunit count turn pStand 1 dStand pBust cBust) 4
    | getHandValue computerHand > 21 && pBust == 1 = EndOfGame (State (playerHand, computerHand, dealerHand, deck) bet cbet cunit count turn pStand 1 dStand pBust cBust) 4
...
-- Determines whether standing or hitting would be optimal
